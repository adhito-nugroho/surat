<?php
  ...
  $sql = $koneksi->query("select * from tkeluar where nomor='$kode'");
...
<?php 
  if (isset($_POST['simpan'])) {
    ...
    if (!empty($lokasi)){
        ...
        $sql = $koneksi->query("update tkeluar SET tanggal='$tanggal',tujuan='$tujuan',perihal='$perihal',keterangan='$keterangan',file='$file' where nomor='$kode'"); 
        if($sql){
    ?>
  ...
  {
    $sql = $koneksi->query("update tkeluar SET tanggal='$tanggal',tujuan='$tujuan',perihal='$perihal',keterangan='$keterangan' where nomor='$kode'"); 
    if($sql){
?>
    <script type="text/javascript">
      alert ("Data Berhasil Disimpan")
